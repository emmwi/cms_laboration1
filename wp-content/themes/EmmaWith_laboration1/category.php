  ...
  <div class="container">
    <div class="row">
      <div id="primary" class="col-xs-12 col-md-9">
        <h1>Kategori: <span>Kategori 1</span> </h1>
        ...
        <div id="sidebar">
          ...
          <ul role="navigation">
            <li id="pages-2" class="widget widget_pages">
              ...
              <ul>
                <li class="page_item page-item-11 current_page_parent"><a href="blogg.html">Blogg</a></li>
            ...
            <li id="categories-2" class="widget widget_categories">
              ...
              <ul>
                <li class="cat-item cat-item-3 current-cat"><a aria-current="page" href="kategori.html">Kategori 1</a> (2)
                </li>
